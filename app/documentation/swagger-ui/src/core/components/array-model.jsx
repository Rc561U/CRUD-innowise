...
export default class ArrayModel extends Component {
  ...
  render(){
    ...
    /*
    Note: we set `name={null}` in <AbstractModel> below because we don't want
    the name of the current AbstractModel passed (and displayed) as the name of the array element AbstractModel
    */
